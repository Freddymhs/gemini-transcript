...
const getTranscriptionSupa = async (url) => {
  const supadata = new Supadata({
    apiKey:
      "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6IjEifQ.eyJpc3MiOiJuYWRsZXMiLCJpYXQiOiIxNzQyNDUxODg4IiwicHVycG9zZSI6ImFwaV9hdXRoZW50aWNhdGlvbiIsInN1YiI6IjNkNzRkMDM0NTlmNDQ0MGE5ZjQ5ODA5OTA2YjY2Y2U1In0.FWmPF1_ObVbm1GG78rm_RtS1cab22od7B8KlaQzCy-0",
  });
